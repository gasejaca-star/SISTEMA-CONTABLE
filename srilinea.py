...
def cargar_usuarios():
    try:
        ...
        st.error("Error de conexión con la base de datos de usuarios.")
        return {}
...
if not st.session_state.autenticado:
    ...
    st.info("### Bienvenido a QUSKY AI\nPor favor, ingresa tus credenciales en el panel de la izquierda para comenzar.")
    st.stop()
...
if uploaded_xmls and st.button("GENERAR REPORTE VISUAL"):
    ...
    for idx, xml in enumerate(uploaded_xmls):
        ...
        progreso.progress((idx + 1) / len(uploaded_xmls))
    ...
    if lista_data:
        ...
        with pd.ExcelWriter(output, engine='xlsxwriter') as writer:
            ...
            # (Aquí se incluyen todos tus formatos de diseño original: f_header_top, f_data_gris, etc.)
            ...
            writer.sheets['COMPRAS'].set_column('A:Q', 15)
            ...
            for r, mes in enumerate(meses):
                ...
                # Fórmulas simplificadas para el ejemplo, pero mantienen tu estructura SUMIFS
