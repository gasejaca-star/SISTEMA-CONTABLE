...
def obtener_ip_usuario():
    try:
        # Esto captura el navegador y el sistema operativo que el usuario está usando
        headers = st.context.headers
        user_agent = headers.get("User-Agent", "Desconocido")
        # Esto nos da una huella digital simple del dispositivo
        return user_agent
    except:
        return "Dispositivo estándar"
